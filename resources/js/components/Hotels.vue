                                ...
                                <div class="details d-flex flex-column flex-grow-1">
                                    ...
                                    <ul class="package-list mt-auto">
                                        <li class="d-flex justify-content-between align-items-center">
                                            <span>Бассейн</span>
                                            <span v-if="hotel.amenities.some(a => a.name === 'Бассейн')">Да</span>
                                            <span v-else>Нет</span>
                                        </li>
                                        <li class="d-flex justify-content-between align-items-center">
                                            <span>Wi-fi</span>
                                            <span v-if="hotel.amenities.some(a => a.name === 'Wi-fi')">Да</span>
                                            <span v-else>Нет</span>
                                        </li>
                                        <li class="d-flex justify-content-between align-items-center">
                                            <span>Кондиционер</span>
                                            <span v-if="hotel.amenities.some(a => a.name === 'Кондиционер')">Да</span>
                                            <span v-else>Нет</span>
                                        </li>
                                        <li class="d-flex justify-content-between align-items-center">
                                            <span>Ресторан</span>
                                            <span v-if="hotel.amenities.some(a => a.name === 'Ресторан')">Да</span>
                                            <span v-else>Нет</span>
                                        </li>
                                        <li class="d-flex justify-content-between align-items-center">
                                            <span>Личный пляж</span>
                                            <span v-if="hotel.amenities.some(a => a.name === 'Личный пляж')">Да</span>
                                            <span v-else>Нет</span>
                                        </li>
                                        <li class="d-flex justify-content-between align-items-center">
                ...
                <div class="col-12 d-flex justify-content-center">
                    <ul class="custom-pagination">
                        ...
                        <li class="page-item" :class="{ disabled: pagination.current_page === 1 }">
                            <a @click.prevent="pagination.current_page > 1 && getHotels(pagination.current_page - 1)" class="page-link">‹</a>
                        </li>
                        ...
                        <li v-for="n in pagination.last_page" :key="n" v-if="showPage(n)"
                            ...
                            <a @click.prevent="getHotels(n)" class="page-link">{{ n }}</a>
                        </li>

                        <!-- Вперед -->
                        <li class="page-item" :class="{ disabled: pagination.current_page === pagination.last_page }">
                            <a @click.prevent="pagination.current_page < pagination.last_page && getHotels(pagination.current_page + 1)" class="page-link">›</a>
                        </li>
                    </ul>
                </div>
            </div>
