                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header d-flex p-3">
                            ...
                            <div class="mr-3">
                                <a href="{{ route('room_type_photo.index', ['room_type' => $room_type->id] ) }}" class="btn btn-primary">Все фото</a>
                            </div>
                        ...
                        <div class="card-body table-responsive p-0">
                            <table class="table table-hover text-nowrap">
                                ...
                                <tr>
                                    <td>Удобства</td>
                                    <td>@foreach($room_type->amenities as $amenity){{$amenity->name}} @endforeach</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <form action="{{ route('room_type.show', ['hotel' => $hotelId, 'room_type' => $room_type]) }}" method="GET" class="form-inline">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            @if(request('search'))
                                                <a href="{{ route('room_type.show', ['hotel' => $hotelId, 'room_type' => $room_type]) }}" class="btn btn-secondary">
                        ...
                        @if(request('search'))
                            <div class="card-body py-2">
                                <div class="alert alert-info mb-0 py-2">
                                    ...
                                    <a href="{{ route('room_type.show', ['hotel' => $hotelId, 'room_type' => $room_type]) }}" class="float-right text-primary">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{ route('room.edit', ['hotel' => $hotelId, 'room_type' => $room_type, $room->id]) }}"
                                                   class="btn btn-warning" title="Редактировать">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('room.delete', ['hotel' => $hotelId, 'room_type' => $room_type, $room->id]) }}"
                                                      method="POST"
                                                      class="d-inline"
                                        ...
                                        <td colspan="8" class="text-center py-5">
                                            @if(request('search'))
                                                <div class="text-muted">
                                                    ...
                                                    <h5>Номера не найдены</h5>
                                                    <p>По запросу "{{ request('search') }}" ничего не найдено</p>
                                                    <a href="{{ route('room_type.show', ['hotel' => $hotelId, 'room_type' => $room_type]) }}" class="btn btn-outline-primary">
                                                        Показать все номера
                                                    </a>
                                                </div>
                                            @else
